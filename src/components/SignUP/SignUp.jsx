        ...
        <form>
            <div className='LoginContainer'>
                <div className='mainLogin'>
                    ...
                    <h3 style={{ textAlign: "center", marginTop: "-15px" }}>Don't have an account?<span style={{ color: "rgb(13,110,253)" }}><Link to="/login" style={{ color: "rgb(32,70,151)", textDecoration: "none" }}> Log In </Link></span></h3>
                    <div className='icons'>
